...
class OxygenService:
    ...
    async def record_daily_oxygen_entry(self, staff_id: str, oxygen_entry: dict, department_id: str):
        ...
        overall_oxygen_consumption = await self.add_to_daily_overall(department_id, oxygen_entry["oxygen_consumption"])
    ...
    async def add_to_daily_overall(self, department_id: str, oxygen_consumption: float):
        ...
        if existing_record:
            ...
            return await db.prisma.dailyoxygenconsumption.update(
                ...
                data={"total_consumption": {"increment": oxygen_consumption}}
            )
        else:
